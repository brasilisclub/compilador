...
title = "Bem-vindos ao Compilador"
description = "Mensagem de introdução do Compilador aos leitores." 
[taxonomies]
categorias = ["Noticia"]
assuntos = ["Introdução", "Apresentação"]
[extra]
keywords = ["Bem-vindo, Compilador, Tecnologia"]
